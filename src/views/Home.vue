<template>
  <div class="fill-height">
    <top-menu :data="markData" @add="addTab" @export="exportFile" @remove="removeTab" @active="activeTab" @import="addImportFile"></top-menu>
      ...
      <v-flex md12 fill-height>
        <v-layout row wrap fill-height overflow-hidden>
          <v-flex md6 fill-height br xs12>
            <div class="tab-name bb body-2 hidden-sm-and-up">
              <p>Markdown</p>
            </div>
